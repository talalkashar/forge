...
export default function ForgeLogo({
    ...
    return (
      ...
      >
        <svg
          ...
          fill="none"
          role="img"
          aria-label="FORGE GYM"
          xmlns="http://www.w3.org/2000/svg"
        >
          <title>FORGE GYM</title>
          <path
  ...
  return (
    ...
    >
      <span
        className={`forge-logo-text font-black uppercase tracking-[0.16em] text-white ${markClassName}`}
      >
        FORGE GYM
      </span>
      <span className="h-2 w-2 shrink-0 rounded-full bg-red-600 shadow-[0_0_18px_rgba(220,38,38,0.75)] transition-transform duration-300 group-hover:scale-125" />
    </Link>
  );
}
