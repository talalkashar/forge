...
// gallery-v7: 1 = dual-angle hero; 2 = specs; 3 = features; 4 = size chart.
// Product lock: blank black lever (no buckle text), all-black leather + black emboss only.
const blackBeltImages = [
  "/images/belts/listing/black/gallery-v7-1.jpg",
  "/images/belts/listing/black/gallery-v7-2.jpg",
  "/images/belts/listing/black/gallery-v7-3.jpg",
  "/images/belts/listing/black/gallery-v7-4.jpg",
];

const blackBeltImageAlts = [
  "FORGE GYM black lever belt dual-angle product view — embossed body logo, blank black steel lever.",
  "FORGE GYM black lever belt specs: 10mm thickness, 4-inch width, blank black lever.",
  "FORGE GYM black lever belt feature callouts — black emboss logo, blank lever, no buckle lettering.",
...
const beltBasePresentation = {
  ...
  descriptionSections: [
    ...
    },
    {
      ...
      images: ["/images/belts/listing/black/gallery-v7-1.jpg"],
